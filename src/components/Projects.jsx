...
const Projects = ({ projectsRef }) => {
  return (
    <div
      ref={projectsRef}
      className=" lg:flex pt-14 mt-10 scroll-m-26 font-noto-serif"
    >
      <div className="lg:w-1/3 px-5 md:px-10 md:mx-8 shadow-lg p-10 rounded-xl mb-10 hover:translate-y-1 hover:scale-105 duration-300 flex flex-col items-center">
        <GiSpiderBot className="text-5xl" />
        <h1 className="text-2xl md:text-3xl my-2 text-center underline underline-offset-2">
          Marketing Reach Rate System
        </h1>
        <p className="text-left pt-3 text-lg md:text-xl">
          {" "}
      ...
      <div className="lg:w-1/3 px-5 md:px-10 md:mx-8 shadow-lg p-10 rounded-xl mb-10 hover:translate-y-1 hover:scale-105 duration-300 flex flex-col items-center">
        ...
        <h1 className="text-2xl md:text-3xl my-2 underline underline-offset-2">
